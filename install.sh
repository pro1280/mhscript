...
install_x-ui() {
    ...
    if  [ $# == 0 ] ;then
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-${arch}.tar.gz https://raw.githubusercontent.com/dalaobiao/x-ui-yg/main/x-ui-linux-${arch}.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://raw.githubusercontent.com/dalaobiao/x-ui-yg/main/x-ui-linux-${arch}.tar.gz"
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/dalaobiao/x-ui-yg/main/x-ui.sh
